...
-- -----------------------------------------------------
-- Table `quan_ly_tien_do_hoc_tap`.`nhom_quyen`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quan_ly_tien_do_hoc_tap`.`nhom_quyen` ;

CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`nhom_quyen` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `ten` NVARCHAR(50) NOT NULL,
  `ghi_chu` TEXT NULL,
  `create_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`chuc_nang_nhom_quyen` (
  ...
  `nhom_quyen_id` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`chuc_nang_id`, `nhom_quyen_id`),
  INDEX `fk_chuc_nang_has_nhom_quyen_nhom_quyen1_idx` (`nhom_quyen_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_chuc_nang_has_nhom_quyen_chuc_nang1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_chuc_nang_has_nhom_quyen_nhom_quyen1`
    FOREIGN KEY (`nhom_quyen_id`)
    REFERENCES `quan_ly_tien_do_hoc_tap`.`nhom_quyen` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- -----------------------------------------------------
-- Table `quan_ly_tien_do_hoc_tap`.`nhom_quyen_tai_khoan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quan_ly_tien_do_hoc_tap`.`nhom_quyen_tai_khoan` ;

CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`nhom_quyen_tai_khoan` (
  `nhom_quyen_id` BIGINT UNSIGNED NOT NULL,
  `tai_khoan_id` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`nhom_quyen_id`, `tai_khoan_id`),
  INDEX `fk_nhom_quyen_has_tai_khoan_tai_khoan1_idx` (`tai_khoan_id` ASC) VISIBLE,
  INDEX `fk_nhom_quyen_has_tai_khoan_nhom_quyen1_idx` (`nhom_quyen_id` ASC) VISIBLE,
  CONSTRAINT `fk_nhom_quyen_has_tai_khoan_nhom_quyen1`
    FOREIGN KEY (`nhom_quyen_id`)
    REFERENCES `quan_ly_tien_do_hoc_tap`.`nhom_quyen` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_nhom_quyen_has_tai_khoan_tai_khoan1`
