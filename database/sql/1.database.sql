...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`chuong_trinh_dao_tao` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `ma_chuong_trinh_dao_tao` VARCHAR(100) NOT NULL,
  `ctdt_cha_id` INT UNSIGNED NULL,
  PRIMARY KEY (`id`),
  ...
  UNIQUE INDEX `ma_chuong_trinh_dao_tao_UNIQUE` (`ma_chuong_trinh_dao_tao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`nien_khoa` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `nganh_id_UNIQUE` (`nganh_id` ASC, `chuong_trinh_dao_tao_id` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`hoc_ky_goi_y` (
  `chuong_trinh_dao_tao_id` INT UNSIGNED NOT NULL,
  `hoc_ky_goi_y` SMALLINT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`dieu_kien_tien_quyet` (
  ...
  `hoc_phan_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`hoc_phan_truoc_id`, `hoc_phan_id`),
...
CREATE TABLE IF NOT EXISTS `quan_ly_tien_do_hoc_tap`.`bai_tap_sinh_vien` (
  ...
  `sinh_vien_id` BIGINT UNSIGNED NOT NULL,
  `diem` INT UNSIGNED NULL DEFAULT 0,
