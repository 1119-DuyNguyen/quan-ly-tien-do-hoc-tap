...
Date.daysBetween = function (date1, date2) {
    ...
    if (difference_ms < 0) return Math.floor(difference_ms / one_day)
    ...
    static run() {
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function createTasks(subject, currentDate = new Date()) {
                ...
                let lengthOfCourse =
                    Date.daysBetween(earliestStart, latestEnd) + 1
                let colors_arr = [
                    'bluepurple',
                    'green',
                    'orange',
                ...
                if (
                    ...
                    if (lengthOfCourse > 7 - betweenDays)
                        // task chiếm hết tuần (kể từ ngày start)
                        width = 7 - betweenDays
                    ...
                    if (width > 1)
                        ...
                        part2 = `<div class="chart__content__col chart__content__col--${subject.color}">
                    <div class="chart__content__title">
                        ${courseName}
                    </div>
                    <div class="chart__content__tasks">
            ...
            function innerMultipleTasks(
                listOfSubjects,
                dateToInner = new Date()
            ) {
