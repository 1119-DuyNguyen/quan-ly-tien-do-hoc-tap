...
route.addRoute('quan-tri-vien/graduate/class/$class_idn', Analytics.class, { title: 'Tiến độ lớp' }, 'templates/admin/class.html');
...
route.addRoute('quan-tri-vien/graduate/student/$sv_username', Analytics.student, { title: 'Tiến độ sinh viên' }, 'templates/admin/student.html');
