...
// Sinh vien
route.addRoute('sinhvien/graduate', Graduate.index, { title: 'Tốt nghiệp' }, 'templates/gradute.html');
route.addRoute('sinhvien/graduate/suggest', Graduate.none, { title: 'Gợi ý' }, 'templates/suggest_graduate.html');
